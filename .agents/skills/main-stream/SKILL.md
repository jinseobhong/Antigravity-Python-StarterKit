...
name: main-stream
description: >-
  Master intent classifier and dynamic track router for Antigravity. Automatically classifies all user inputs into 4 distinct tracks (1. Quick Track, 2. Spike Track, 3. Standard Architecture Track, 4. General/Conversational Track) and enforces CDD & E2E verification.
---
...
# Master Intent Classifier & Track Router Runbook
...
이 스킬은 사용자의 프롬프트를 실시간 분류하여 가장 안전하고 빠른 최적 트랙으로 라우팅한다.
