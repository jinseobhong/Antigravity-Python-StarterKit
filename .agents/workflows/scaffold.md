---
description: >-
  Automated Scaffolding Workflow (/scaffold). Creates boilerplate files, directories, and symmetric configurations in 100% compliance with CDD & CONVENTIONS.md.
---
...
이 워크플로우는 프로젝트 규격 및 CDD API 계약에 맞추어 디렉토리, 템플릿 파일, 워크플로우-스킬 대칭 쌍을 자동 생성합니다.
