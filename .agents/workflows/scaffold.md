---
description: >-
  Automated file, module, and directory scaffolding workflow for Antigravity. Enforces 100% compliance with CDD contracts, CONVENTIONS.md, and STYLE_GUIDE.md.
---
...
# 🏗️ Scaffolding & Blueprint Workflow
...
1. **디렉터리 및 구조 검토**: `FILESYSTEM_SPEC.md` 표준 확인.
2. **템플릿 인스턴스화**: 표준 템플릿 기반으로 파일 생성.
3. **패키지 바인딩**: `__init__.py` 및 모듈 익스포트 구성.
4. **원클릭 전사 검증**: `py -3 .agents/scripts/run_checks.py`로 100% 무결성 실측 입증.
