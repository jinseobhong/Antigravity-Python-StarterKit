---
description: >-
  Reverse Engineering & Legacy Analysis Workflow (/reverse-engineer). Inspects legacy code, enforces CDD contracts, and synthesizes views/ARCHITECTURE.md.
---
...
# Reverse Engineering Workflow (`/reverse-engineer`)
...
이 워크플로우는 기존 레거시 코드베이스를 정밀 분석하여 **도메인 모델 추출, 비즈니스 규칙 명세, 아키텍처 청사진(`docs/architecture/ARCHITECTURE.md`) 합성**을 수행합니다.
